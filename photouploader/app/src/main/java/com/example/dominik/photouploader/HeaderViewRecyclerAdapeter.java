...
public abstract  class HeaderViewRecyclerAdapeter<H extends RecyclerView.ViewHolder, F extends RecyclerView.ViewHolder, C extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
     ...
     * @return the view holder.
     */
    protected abstract F onCreateFooterItemViewHolder(ViewGroup parent, int footerViewType);
     ...
     * @param position         the position.
     */
    protected abstract void onBindFooterItemViewHolder(F footerViewHolder, int position);
